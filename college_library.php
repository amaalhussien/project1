    ...
    <div class="asd">
        ...
        <div class="row">
                     <div class="col-sm-12">
                         <br>
                         <br>
                         <h1> مكتبة الكلية / <?php echo $coll['name_Colleges'] ?></h1>
                         <?php echo msg(); ?>
                                     <?php $errors=er(); ?>
     ...
     }elseif($do=='Approve')
    {
        ...
        echo "<div class='container'>";
            ...
            // Select All Data Depend On This ID
                ...
                if($check>0){
                $sql="UPDATE  `student` SET `college_library`=1  WHERE student_id={$student} LIMIT 1";
    ...
    }elseif($do=='notApprove')
    {
        ...
        echo "<div class='container'>";
            ...
            // Select All Data Depend On This ID
                ...
                $check=checkItem('student_id','student',$student);
                if($check>0){
                $sql="UPDATE  `student` SET `college_library`=0  WHERE student_id={$student} LIMIT 1";
                    $result=mysqli_query($conn,$sql);
                        if ( $result && mysqli_affected_rows($conn)>0) {
