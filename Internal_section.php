               ...
               <form class="form-horizontal" action="?do=viwe" method="post"
                         name="frmCSVImport" id="frmCSVImport" enctype="multipart/form-data">
                            ...
                            <div class="inputText">Frist Name</div>
                                     <input type="text" class="input"  name="fristname" autocomplete="off" required="required" placeholder="Username To Login Into">
                                  </div>
                                 
                             
                               <div class="inputBox">
                            <div class="inputText">Last Name</div>
                                     <input type="text" class="input"  name="lastname" autocomplete="off" required="required" placeholder="Username To Login Into">
                                  </div>
...
<?php
             if(isset($_POST['import'])){
                        ...
                        `frist_name` LIKE '%$fristname%' OR `last_name` LIKE '%$lastname%' 
                        AND`id_department`=$department AND`id_college`=$college ";
